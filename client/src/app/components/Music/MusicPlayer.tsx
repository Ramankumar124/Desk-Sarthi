  ...
  return (
    <div className=" bg-secondary grid grid-cols-1 md:grid-cols-2 md:flex text-primary w-full gap-8 p-2  ">
      ...
      <div className="bg-neutral-800 rounded-xl p-6 border border-neutral-700/30 hover:border-neutral-600/50 transition-all">
            <h3 className="text-white mb-6 text-lg font-semibold">Music Player</h3>
            <div className="relative  mb-6">
                <input type="text" placeholder="Search for music..." className="w-full bg-neutral-700 text-white rounded-lg
            ...
            <div className="bg-neutral-700/30 rounded-xl p-4 mb-6">
                ...
                <div className=" md:mb-4">
                    ...
                    <Slider  onValueChange={()=>console.log("helloe")} defaultValue={[33]} max={100} step={1} />
