...
const WeatherIndoor = () => {
  const temperature = 22; // Replace with dynamic data if needed
  ...
  return (
    <div className="bg-neutral-800 p-4 rounded-lg text-white flex flex-col items-center gap-4 w-full min-h-[200px] max-w-md md:w-[500px]">
